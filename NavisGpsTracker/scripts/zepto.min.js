...
(function ($) {
    ...
    $.fn.outerHeight = function (includeMargins) {
        ...
        var res = this[0].offsetHeight + (includeMargins ? parseInt(style.marginTop, 10) + parseInt(style.marginBottom, 10) : 0);
        return res;
    };
